...
\text{weights_1} &= \left[ r^0, r^1, r^2, \ldots, r^{n-1} \right] 


\text{weights_2} &= \left[ r^{n-1}, r^{n-2}, \ldots, r^1, r^0 \right]

\text{weights_1} &= \frac{weights_1}{\sum weights_1} \times n/\sqrt{2}

\text{weights_2} &= \frac{weights_2}{\sum weights_2} \times {n}/\sqrt{2}

 \text{weights} &= \text{torch.cat}(\text{weights_1}, \text{weights_2}) 
```
